...
<div style="background: url('/images/bg.png')  no-repeat; height: 900px; position: relative;">
    <#--    <a href="http://www.test.com"><img alt="www.test.com" src="../images/logo.png"></a>-->
    ...
    <div style="margin-left: 50%;font-size: 20px"><a href="http://www.test.com" target="_black">www.test.com</a></div>
